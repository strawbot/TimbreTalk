...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.SetSfp = QtGui.QRadioButton(Frame)
        ...
        self.horizontalLayout.addWidget(self.SetSfp)
        self.SetSerial = QtGui.QRadioButton(Frame)
        self.SetSerial.setObjectName(_fromUtf8("SetSerial"))
        self.buttonGroup.addButton(self.SetSerial)
        self.horizontalLayout.addWidget(self.SetSerial)
